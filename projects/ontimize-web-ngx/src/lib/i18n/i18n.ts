...
export const MAP = {
  ...
  en: {
    ...
    'MESSAGES.CONFIRM_DELETE_ITEM': 'Are you sure you want to delete this item?',
  ...
  es: {
    ...
    'MESSAGES.CONFIRM_DELETE': '¿Está seguro de que quiere borrar los registros seleccionados?',
    'MESSAGES.CONFIRM_DELETE_ITEM': '¿Está seguro de que quiere borrar este registro?',
  ...
  pt: {
    ...
    'MESSAGES.CONFIRM_DELETE': 'Tem certeza que quer apagar os ítems selecionados?',
    'MESSAGES.CONFIRM_DELETE_ITEM': 'Tem certeza que quer apagar este ítem?',
