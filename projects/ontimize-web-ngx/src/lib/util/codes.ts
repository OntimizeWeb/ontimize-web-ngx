...
export class Codes {
  ...
  public static TABLE_FILTER_BY_COLUMN_DATA_DIALOG_CLEAR_FILTER_ACTION = 'clear';
  public static TABLE_FILTER_BY_COLUMN_DATA_DIALOG_FILTER_ACTION = true;
  public static TABLE_FILTER_BY_COLUMN_DATA_DIALOG_CANCEL_ACTION = false;
  public static TABLE_FILTER_BY_COLUMN_DATA_DIALOG_RESULTS = [
    Codes.TABLE_FILTER_BY_COLUMN_DATA_DIALOG_FILTER_ACTION,
    Codes.TABLE_FILTER_BY_COLUMN_DATA_DIALOG_CANCEL_ACTION,
    Codes.TABLE_FILTER_BY_COLUMN_DATA_DIALOG_CLEAR_FILTER_ACTION
  ];
