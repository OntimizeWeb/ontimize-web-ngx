...
describe('OValidatorComponent', () => {
  let component: OValidatorComponent;
  let fixture: ComponentFixture<OValidatorComponent>;
  ...
  it('should have basic component structure', () => {
    expect(component).toBeInstanceOf(OValidatorComponent);
  });
});
