...
import { OStoreFilterDialogComponent } from './o-store-filter-dialog.component';
...
describe('OStoreFilterDialogComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [OStoreFilterDialogComponent],
      imports: [
  ...
  it('should have basic component structure', () => {
    expect(component).toBeInstanceOf(OStoreFilterDialogComponent);
  });
});
