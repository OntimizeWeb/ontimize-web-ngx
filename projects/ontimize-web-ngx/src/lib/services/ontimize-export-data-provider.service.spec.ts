...
describe('OntimizeExportDataProviderService', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [
        OntimizeExportDataProvider.service,
    ...
    try {
      service = TestBed.inject(OntimizeExportDataProvider.service);
    } catch (error) {
      // Si el servicio no se puede inyectar, créalo manualmente
      service = new OntimizeExportDataProviderService();
    }
  });
  ...
  it('should be instance of OntimizeExportDataProvider.service', () => {
