...
describe('OTableCellEditorDateComponent', () => {
  ...
  beforeEach(async () => {
    try {
      ...
      OTableCellEditorDateComponent = module.OTableCellEditorDateComponent;
    } catch (e) {
    ...
    if (!OTableCellEditorDateComponent) { return; }
    component = Object.create(OTableCellEditorDateComponent.prototype);
  });
