...
describe('OTableCellEditorTextComponent', () => {
  ...
  let fixture: ComponentFixture<OTableCellEditorTextComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [OTableCellEditorTextComponent, ...OTestingUtils.getCommonDeclarations()],
      imports: [
  ...
  it('should have basic component structure', () => {
    expect(component).toBeInstanceOf(OTableCellEditorTextComponent);
  });
});
