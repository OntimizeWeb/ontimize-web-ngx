...
describe('OTableCellRendererCurrencyComponent', () => {
  ...
  beforeEach(async () => {
    try {
      ...
      OTableCellRendererCurrencyComponent = module.OTableCellRendererCurrencyComponent;
    } catch (e) {
    ...
    if (!OTableCellRendererCurrencyComponent) { return; }
    component = Object.create(OTableCellRendererCurrencyComponent.prototype);
  });
