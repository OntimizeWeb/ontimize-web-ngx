...
describe('OComboComponent', () => {
  ...
  beforeEach(async () => {
    ...
    const module = await import('./o-combo.component');
    OComboComponent = module.OComboComponent;
  ...
  it('should have basic component structure', () => {
    expect(component.constructor).toBe(OComboComponent);
  });
});
