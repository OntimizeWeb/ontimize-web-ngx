...
let OComboRendererCurrencyComponent: any;
...
describe('OComboRendererCurrencyComponent', () => {
  ...
  beforeEach(async () => {
    ...
    const module = await import('./o-combo-renderer-currency.component');
    OComboRendererCurrencyComponent = module.OComboRendererCurrencyComponent;
  ...
  it('should have basic component structure', () => {
    expect(component.constructor).toBe(OComboRendererCurrencyComponent);
  });
});
