...
let OComboRendererIconComponent: any;
...
describe('OComboRendererIconComponent', () => {
  ...
  beforeEach(async () => {
    ...
    const module = await import('./o-combo-renderer-icon.component');
    OComboRendererIconComponent = module.OComboRendererIconComponent;
  ...
  it('should have basic component structure', () => {
    expect(component.constructor).toBe(OComboRendererIconComponent);
  });
});
