...
let OComboRendererPercentageComponent: any;
...
describe('OComboRendererPercentageComponent', () => {
  ...
  beforeEach(async () => {
    ...
    const module = await import('./o-combo-renderer-percentage.component');
    OComboRendererPercentageComponent = module.OComboRendererPercentageComponent;
  ...
  it('should have basic component structure', () => {
    expect(component.constructor).toBe(OComboRendererPercentageComponent);
  });
});
