...
let OComboRendererRealComponent: any;
...
describe('OComboRendererRealComponent', () => {
  ...
  beforeEach(async () => {
    ...
    const module = await import('./o-combo-renderer-real.component');
    OComboRendererRealComponent = module.OComboRendererRealComponent;
  ...
  it('should have basic component structure', () => {
    expect(component.constructor).toBe(OComboRendererRealComponent);
  });
});
