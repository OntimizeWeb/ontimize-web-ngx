...
let OListPickerRendererRealComponent: any;

describe('OListPickerRendererRealComponent', () => {
  let component: any;

  beforeEach(async () => {
    // Dynamically import to avoid early compilation
    const module = await import('./o-list-picker-renderer-real.component');
    OListPickerRendererRealComponent = module.OListPickerRendererRealComponent;
    ...
    component = TestBed.runInInjectionContext(() => new OListPickerRendererRealComponent(mockInjector));
  });
  ...
  it('should have basic component structure', () => {
    expect(component.constructor).toBe(OListPickerRendererRealComponent);
  });
});
