...
let OListPickerRendererIntegerComponent: any;
...
describe('OListPickerRendererIntegerComponent', () => {
  ...
  beforeEach(async () => {
    ...
    const module = await import('./o-list-picker-renderer-integer.component');
    OListPickerRendererIntegerComponent = module.OListPickerRendererIntegerComponent;
    ...
    component = TestBed.runInInjectionContext(() => new OListPickerRendererIntegerComponent(mockInjector));
  });
  ...
  it('should have basic component structure', () => {
    expect(component.constructor).toBe(OListPickerRendererIntegerComponent);
  });
});
