...
let OListPickerRendererDateComponent: any;
...
describe('OListPickerRendererDateComponent', () => {
  ...
  beforeEach(async () => {
    ...
    const module = await import('./o-list-picker-renderer-date.component');
    OListPickerRendererDateComponent = module.OListPickerRendererDateComponent;
  ...
  it('should have basic component structure', () => {
    expect(component.constructor).toBe(OListPickerRendererDateComponent);
  });
});
