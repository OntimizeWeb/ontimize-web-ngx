...
let OListPickerRendererPercentageComponent: any;
...
describe('OListPickerRendererPercentageComponent', () => {
  ...
  beforeEach(async () => {
    ...
    const module = await import('./o-list-picker-renderer-percentage.component');
    OListPickerRendererPercentageComponent = module.OListPickerRendererPercentageComponent;
  ...
  it('should have basic component structure', () => {
    expect(component.constructor).toBe(OListPickerRendererPercentageComponent);
  });
});
