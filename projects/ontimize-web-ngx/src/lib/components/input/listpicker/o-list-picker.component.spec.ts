...
describe('OListPickerComponent', () => {
  ...
  beforeEach(async () => {
    ...
    const module = await import('./o-list-picker.component');
    OListPickerComponent = module.OListPickerComponent;
  ...
  it('should have basic component structure', () => {
    expect(component.constructor).toBe(OListPickerComponent);
  });
});
