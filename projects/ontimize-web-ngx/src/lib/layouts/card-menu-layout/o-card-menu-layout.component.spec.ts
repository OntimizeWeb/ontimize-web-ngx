...
let OCardMenuLayoutComponent: any;
...
describe('OCardMenuLayoutComponent', () => {
  ...
  beforeEach(async () => {
    ...
    const module = await import('./o-card-menu-layout.component');
    OCardMenuLayoutComponent = module.OCardMenuLayoutComponent;
  ...
  it('should have basic component structure', () => {
    expect(component.constructor).toBe(OCardMenuLayoutComponent);
  });
});
