...
import {Overlay, OVERLAY_PROVIDERS} from '@angular2-material/core';
...
@NgModule({
  declarations: [MdDialogTitle, MdDialogActions, MdDialogPortal, MdDialog],
  imports: [CommonModule],
  exports: [MdDialogTitle, MdDialogActions, MdDialogPortal, MdDialog],
})
