import {Component, Input, Output, EventEmitter, ContentChild,
...
@NgModule({
  declarations: [MdDataTableHeaderSelectableRow, MdDataTableSelectableRow, MdDataTable],
  imports: [MdCheckboxModule],
  exports: [MdDataTableHeaderSelectableRow, MdDataTableSelectableRow, MdDataTable],
})
