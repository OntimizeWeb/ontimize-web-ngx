export var MAP = {
  ...
  'en': {
    ...
    'TABLE.DIALOG.EMPTY_CONFIGURATIONS_LIST': 'There are no stored configurations',
  ...
  'es': {
    ...
    'TABLE.DIALOG.EMPTY_CONFIGURATIONS_LIST': 'No hay configuraciones almacenadas',
