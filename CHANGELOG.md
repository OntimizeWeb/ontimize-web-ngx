...
* **o-table**:
  * Fixed bug that incorrectly detected o-table-button components ([6efadcc5](https://github.com/OntimizeWeb/ontimize-web-ngx/commit/6efadcc5)) Closes [#1026](https://github.com/OntimizeWeb/ontimize-web-ngx/issues/1026)
