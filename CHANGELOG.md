## 8.14.16 (2024-06-10)
### Bug fixes
* **o-card-menu-layout**:  Fixed that the component defined in the app.menu.config.ts file was not displayed([](https://github.com/OntimizeWeb/ontimize-web-ngx/pull/1593/commits/)) Closes [#1618](https://github.com/OntimizeWeb/ontimize-web-ngx/issues/1618)
