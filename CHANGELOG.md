...
### Bug fixes
  ...
  * **o-table**: added new input `expandable-callback` to make changes on expandable-row ([3225048](https://github.com/OntimizeWeb/ontimize-web-ngx/commit/3225048)) Closes [#811](https://github.com/OntimizeWeb/ontimize-web-ngx/issues/811)
