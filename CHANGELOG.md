...
### Bug fixes
* **o-button**: Fixed that when the text is too long it shows ellipsis instead of line break Closes [#1855](https://github.com/OntimizeWeb/ontimize-web-ngx/issues/1855)
* **o-table-columns-filter, o-table-columns-filter-column**: Fixed that *All pages* does not work if there is a previously selected option Closes [#1849](https://github.com/OntimizeWeb/ontimize-web-ngx/issues/1849)
