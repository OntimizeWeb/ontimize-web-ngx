...
### Bug Fixes
* **o-table**: fix group row background color not applied to last column when row selection is enabled ([11a9112](https://github.com/OntimizeWeb/ontimize-web-ngx/commit/11a91121a09419e6ceb7d2e4c13c63fcb6834c62)) Closes [#2093](https://github.com/OntimizeWeb/ontimize-web-ngx/issues/2093)
