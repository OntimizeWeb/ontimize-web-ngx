...
* **o-form**: new `getFieldValue`, `getFieldValues`, `setFieldValue`,  `deleteFieldValue` and `getFieldReference` method ([3453182](https://github.com/OntimizeWeb/ontimize-web-ngx/commit/3453182))
