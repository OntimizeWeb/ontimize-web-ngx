...
* **o-table**: fixed when add new columns to my tables they are being hidden by default.
...
* **o-checkbox**: checkbox with no boolean values ([f871ac7d](https://github.com/OntimizeWeb/ontimize-web-ngx/commit/f871ac7d)) Closes [#286](https://github.com/OntimizeWeb/ontimize-web-ngx/issues/286)
